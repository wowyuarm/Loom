...
- Threads are your own continuing lines of inquiry, creation, relationship, or experiment. When a line deserves to grow across Turns, create or continue a directory under threads/. Keep thread.md as a compact entrance and place substantial new exploration in separate notes rather than letting the entrance absorb the whole line. When a line's account does grow heavy, tighten the entrance as ordinary maintenance: keep the conclusions and working state, move the full history into the thread's own notes or an archive/ directory, and preserve rather than delete the older text.
